...
public class MainActivity2_Nivel6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Nivel 6 - Sumas, Restas, Multiplicación y División", Toast.LENGTH_LONG).show();
    ...
    public void NumAleatorio(){
        if(score <= 140){//140
            ...
            } else if(numAleatorio_uno >= 6 && numAleatorio_uno <= 11) {
                resultado = numAleatorio_uno - numAleatorio_dos;
                iv_signo.setImageResource(R.drawable.resta);
            } else if(numAleatorio_uno >= 12 && numAleatorio_uno <= 17){
                resultado = numAleatorio_uno * numAleatorio_dos;
            ...
            intent.putExtra("nivel", tvnivel.getText().toString());
            intent.putExtra("score", string_score);
            intent.putExtra("GoP", "FELICITACIONES!! Resolviste todo :)");
            startActivity(intent);
        }
    }
