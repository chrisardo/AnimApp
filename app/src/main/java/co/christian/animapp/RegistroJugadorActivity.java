...
public class RegistroJugadorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerAvatars =(RecyclerView)findViewById(R.id.recAvatarsId);
        //btnAtras = (ImageButton)findViewById(R.id.btnIcoAtras);
        imagenAvatar=(ImageView)findViewById(R.id.imageView_Personaje);
        fabRegistro=(FloatingActionButton) findViewById(R.id.idFabRegis);
        campoNick=(EditText) findViewById(R.id.campoNombre);
        radioM=(RadioButton)findViewById(R.id.radioMas);
        radioF=(RadioButton) findViewById(R.id.radioFem);
    ...
    public AlertDialog createSimpleDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(RegistroJugadorActivity.this,R.style.DialogSalida);
