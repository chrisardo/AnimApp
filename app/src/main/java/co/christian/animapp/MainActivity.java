...
public class MainActivity extends AppCompatActivity implements IComunicaFragments, InicioFragment.OnFragmentInteractionListener,
    ...
    public void consultarInstrucciones() {
        Intent instruccion = new Intent(MainActivity.this, ContenedorInstruccionesActivity.class);
    ...
    public void consultarInformacion() {
        ...
        Intent intent=new Intent(this, InforApp.class);
        startActivity(intent);
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == event.KEYCODE_BACK) {
            ...
            builder.setMessage("¿Desea salir de AnimApp?")
